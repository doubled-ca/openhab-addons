...
public class AudioAuthorityTelnetClientThread extends Thread {
    ...
    private AudioAuthorityTelnetListener listener;
    ...
    public AudioAuthorityTelnetClientThread(AudioAuthorityConfiguration config, AudioAuthorityTelnetListener listener) {
        logger.debug("AudioAuthority listener created");
        this.config = config;
