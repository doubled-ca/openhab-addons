...
/**
 * The {@link AudioAuthority3Handler} is responsible for handling commands, which are
 * sent to one of the channels.
 *
 * @author Dennis Drapeau - Initial contribution
 */
@NonNullByDefault
public class AudioAuthority3Handler extends BaseThingHandler {

    private final Logger logger = LoggerFactory.getLogger(AudioAuthority3Handler.class);

    private @Nullable AudioAuthority3Configuration config;
